...
public class Role extends BaseEntity {
	...
	@Column(name = "if_check_role", length = 10)
	private String ifCheckRole;//查阅角色
	 ...
	 * @param ifCheckRole
	 */
	public Role(Integer id, String name, String status, String ifTodoList, String ifCheckRole) {
		super();
		this.id = id;
		this.name = name;
		this.status = status;
		this.ifTodoList = ifTodoList;
		this.ifCheckRole = ifCheckRole;
	}
	...
	public String getIfCheckRole() {
		return ifCheckRole;
	}
	public void setIfCheckRole(String ifCheckRole) {
		this.ifCheckRole = ifCheckRole;
	}
