...
@Entity
@Table(name = "REPORT_MONTH_ORG", schema = TJ_SCHEMA)
public class ReportMonthOrg {
	...
	private String applyUserId;//客户经理ID
	
	@Column(name="APPLY_USER_NAME",length=100)
	private String applyUserName;//客户经理名称
	...
	public ReportMonthOrg(){
		super();
	}

	public ReportMonthOrg(String reportId, String busiMonth, Integer rankNum,
			String orgId, String orgName, String applyUserId,
			String applyUserName, BigDecimal amt1, BigDecimal amt2,
