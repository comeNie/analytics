...
@Entity
@Table(name = "REPORT_CHART_COORDINATE", schema = TJ_SCHEMA)
public class ReportChartCoordinate extends BaseEntity {
	...
	private String searchPath;//路径
	@Column(name="REPORT_TYPE",length=1)
	private String reportType;//报表类型（1.表2.图3.混合）
	@Column(name="SCRIPT_BEFORE",length=3000)
	private String scriptBefore;//表前文字
	@Column(name="SCRIPT_AFTER",length=3000)
	private String scriptAfter;//表后文字
	...
	private Integer y2;
	@Column(name="label")
	private String label;//类型（1是单个，2是所有小贷）
	@Column(name="SEQUENCE")
	private String sequence;
	@Column(name="TASK_ID")
	private String taskId;
	
	public ReportChartCoordinate(Long rowId, String reportName,
			String searchPath, Integer x1, Integer y1, Integer x2, Integer y2) {
		super();
		this.rowId = rowId;
