 ...
 */
public class UnixCrypt implements ICrypt
{
  ...
  {
    UnixCrypt e = new UnixCrypt();
    String pwd = "arison";
    String epwd = e.crypt(pwd);
    //e.setPassword( pwd) ;
    System.out.println("arison���ܺ�Ϊ: " + pwd + " ==>" + epwd);
    System.out.println(e.matches("vcftbS8aHMdxI","arison"));
