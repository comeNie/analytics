...
<div class="ajaxContent" >
	<div class="page-header">
		<h1>系统管理>报表说明维护
			 <small> 
				<i class="ace-icon fa fa-angle-double-right"></i> 报表说明维护 
			</small>
		</h1>
	</div>
		...
		<div class="col-xs-12">
			<form class="form-horizontal" id="searchForm">
				<div class="form-group">
					<label class="control-label col-sm-2">请选择报表：</label>
	...
	<div class="row" style="height: 0px;">
		<div class="col-xs-12">
			<form class="form-horizontal">
				<div class="form-group">
					<label class="control-label col-sm-2">报表说明：</label>
					<div class="col-sm-10">
						<span><textarea id="indexShows" name="indexShows" style="width: 56%;height:150px"> </textarea></span>
						<br/><br/>
						<div>
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<div class="modal-footer">
						<button type="button" id="btn-addIndex-submit" class="btn btn-sm btn-primary">
