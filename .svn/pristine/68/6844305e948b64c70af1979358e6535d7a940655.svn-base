		...
		<form class="form-horizontal" role="form">
			<div class="form-group">
				...
				<div class="col-sm-9">
					...
					<a href="javascript:void(0);" id="all-jg-select" title="所有机构">
						<i class="ace-icon glyphicon glyphicon-ok"></i>
					</a> 
					<a href="javascript:void(0);" id="all-xd-select" title="所有小贷">
						<i class="ace-icon glyphicon glyphicon-check"></i>
					</a> 
					<a href="javascript:void(0);" id="all-select-excTeam" title="全选(不含工作组)">
						<i class="ace-icon glyphicon glyphicon-edit"></i>
					</a>
					<a href="javascript:void(0);" id="del-select" title="取消选中">
